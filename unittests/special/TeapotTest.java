...
public class TeapotTest {
	...
	public void teapotMTCBR() {
		...
		scene.lights.add(new PointLight(new Color(500, 500, 500), new Point(100, 0, -100)).setKq(0.000001));
		final ImageWriter imageWriter = new ImageWriter("teapotMTCBR", 800, 800);
